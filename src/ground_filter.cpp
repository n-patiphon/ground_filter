...
GroundFilter::GroundFilter() : n("~")
{
	...
	n.param<std::string>("point_topic", point_topic, "/velodyne_points");
	...
	sub = n.subscribe(point_topic, 10, &GroundFilter::velodyneCallback, this);
        vertical_points_pub = n.advertise<sensor_msgs::PointCloud2>("/vertical_points", 10);
        ground_points_pub = n.advertise<sensor_msgs::PointCloud2>("/ground_points", 10);
